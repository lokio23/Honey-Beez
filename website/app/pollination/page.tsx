...
const puzzlePairs: PuzzlePair[] = [
  {
    bee: { name: "Bumblebee", emoji: "🐝", hint: "I can vibrate at middle C!" },
    flower: { name: "Tomato", emoji: "🍅", hint: "I need a special shake to release my pollen" },
    explanation: "Tomatoes need 'buzz pollination' — only bumblebees can vibrate at exactly the right frequency (middle C, ~130 Hz) to shake the pollen loose!",
  },
  {
    bee: { name: "Honeybee", emoji: "🍯", hint: "I have a long tongue and love sweet nectar" },
    flower: { name: "Clover", emoji: "☘️", hint: "I'm a tiny flower packed with sweet nectar" },
    explanation: "Honeybees and clover are a classic partnership! Clover produces abundant nectar that honeybees transform into some of the most popular honey in the world.",
  },
  {
    bee: { name: "Mason Bee", emoji: "🏗️", hint: "I'm messy and roll around in pollen" },
    flower: { name: "Apple Blossom", emoji: "🌸", hint: "I need lots of pollen transferred between trees" },
    explanation: "Mason bees are 120x more efficient at pollinating apple trees than honeybees! They belly-flop into flowers and get covered in pollen, which they spread everywhere.",
  },
  {
    bee: { name: "Long-tongued Bee", emoji: "👅", hint: "I can reach deep into tubular flowers" },
    flower: { name: "Foxglove", emoji: "🔔", hint: "My nectar is hidden deep inside bell-shaped flowers" },
    explanation: "Foxglove flowers are shaped like long tubes — only bees with extra-long tongues can reach the nectar at the bottom. This is called co-evolution!",
  },
  {
    bee: { name: "Carpenter Bee", emoji: "🪵", hint: "I'm big and strong but can't reach deep nectar" },
    flower: { name: "Passion Flower", emoji: "💜", hint: "I'm flat and open with easy-to-reach pollen" },
    explanation: "Carpenter bees love open, flat flowers where they can easily land and access pollen. Passion flowers have a wide landing platform perfect for these large bees!",
  },
  {
    bee: { name: "Sweat Bee", emoji: "💎", hint: "I'm tiny and love small, simple flowers" },
    flower: { name: "Daisy", emoji: "🌼", hint: "I'm actually many tiny flowers in a disc shape" },
    explanation: "Daisies are perfect for small bees! What looks like one flower is actually hundreds of tiny flowers (florets) packed together — like a buffet for small pollinators!",
  },
];
    ...
    <div className="min-h-screen bg-gradient-to-b from-pink-50 to-cream">
      ...
      <div className="bg-gradient-to-r from-pink-500 to-pink-600 py-8 px-4 text-center">
        ...
        <p className="text-pink-100 text-lg max-w-2xl mx-auto">
          Match each bee to its perfect flower partner! Different bees specialize in different flowers.
        </p>
      </div>
        ...
        {!gameStarted ? (
          ...
          <div>
            ...
            <div className="grid md:grid-cols-2 gap-8">
              {/* Bees Column */}
              <div>
                <h3 className="font-display font-bold text-amber-800 mb-3 text-center">🐝 Bees</h3>
              ...
              {/* Flowers Column */}
              <div>
                <h3 className="font-display font-bold text-pink-800 mb-3 text-center">🌸 Flowers</h3>
                <div className="space-y-3">
