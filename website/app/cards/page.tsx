        ...
        >
          ...
          <div className="absolute bottom-2 left-0 right-0 text-center">
            <span className="text-[8px] text-gray-300 font-display font-bold">
              HONEY BEEZ • #{allSpecies.indexOf(species) + 1}/{allSpecies.length}
            </span>
          </div>
        </div>
      </motion.div>
    ...
    <div className="min-h-screen bg-gradient-to-b from-amber-100 to-cream">
      ...
      <div className="bg-gradient-to-r from-amber-500 to-amber-600 py-8 px-4 text-center">
        ...
        <p className="text-amber-100 text-lg max-w-2xl mx-auto">
          Collect all 20 bee species cards! Click any card to flip it over and see the stats.
        </p>
      </div>
      ...
      <div className="max-w-6xl mx-auto px-4 py-8">
        ...
        <div className="flex justify-center gap-4 mb-8">
          ...
          >
            Pack 1 ({allSpecies.filter((s) => s.pack === 1).length} cards)
          </button>
          <button
          ...
          >
            Pack 2 ({allSpecies.filter((s) => s.pack === 2).length} cards)
          </button>
        </div>
